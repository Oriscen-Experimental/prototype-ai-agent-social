...
def build_planner_prompt(
    *,
    ...
    return (
        ...
        "  - candidates: planner must extract the correct 'results' items from history based on user intent\n"
        "    - User may refer to current visible results, or earlier results (e.g. '上上批次结果')\n"
        "    - Planner should analyze context to determine which results the user wants to refine\n"
        "  - Does NOT do new search, only refines the provided candidates\n"
        "\n"
