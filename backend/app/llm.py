...
def build_planner_prompt(
    *,
    ...
    return (
        ...
        "- Location: If user previously specified a city/location for any search, reuse it unless they explicitly mention a different location\n"
        "- Domain: If clearly implied by the request (e.g., '找人打球' → domain='person', '找活动' → domain='event')\n"
        "Only infer parameters that are OBVIOUS from context. When in doubt, ask.\n"
